# ==============================================================================
# SCRIPT: Generate_Supplementary_Figure_4_Master_Plate.R
# PROJECT: Liver Fibrosis Protein Modeling Consortium (Supplemental Figures)
# PURPOSE: Assemble Supplementary Figure 4 in a 2-Tier Vertical Stack:
#          - Tier 1: Panel A (Procedure_1_4Models_Pearson_Richtung1_Train_BDL_Test_CCl4 - Top)
#          - Tier 2: Panel B (Procedure_1_4Models_Pearson_Richtung2_Train_CCl4_Test_BDL - Bottom)
# ==============================================================================
...
out_pdf      <- file.path(grafiken_dir, "Supplementary_Figure_3AB.pdf")
...
f_p5_a <- file.path(boxplot_dir, "Procedure_1_4Models_Pearson_Richtung1_Train_BDL_Test_CCl4.pdf")
f_p5_b <- file.path(boxplot_dir, "Procedure_1_4Models_Pearson_Richtung2_Train_CCl4_Test_BDL.pdf")
...
ggsave(out_pdf, plot = master_canvas, width = 20, height = 22, units = "in", dpi = 300)
