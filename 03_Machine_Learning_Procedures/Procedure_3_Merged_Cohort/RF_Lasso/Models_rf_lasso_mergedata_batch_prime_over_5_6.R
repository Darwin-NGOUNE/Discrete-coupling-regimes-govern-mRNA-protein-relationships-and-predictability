...
lasso.rf.pre.full.mergedata_blind_rna_batch_prime_over_5_6 <- pblapply(FUN = protein.regression.complete,
                                                           pairs.list.final,
                                                           dataset = Full_DT,
                                                           weighted = FALSE,
                                                           grouping = "all",
...
lasso.rf.pre.full.mergedata_blind_protein_batch_prime_over_5_6 <- pblapply(FUN = protein.regression.complete,
                                                           pairs.list.final,
                                                           dataset = Full_DT,
                                                           weighted = FALSE,
                                                           grouping = "all",
...
lasso.rf.pre.full.mergedata_blind_combined_batch_prime_over_5_6 <- pblapply(FUN = protein.regression.complete,
                                                           pairs.list.final,
                                                           dataset = Full_DT,
                                                           weighted = FALSE,
                                                           grouping = "all",
...
# SAVE RESULTS
save(lasso.rf.pre.full.mergedata_blind_rna_batch_prime_over_5_6,
     lasso.rf.pre.full.mergedata_blind_protein_batch_prime_over_5_6,
     lasso.rf.pre.full.mergedata_blind_combined_batch_prime_over_5_6,
     file = "Models_rf_preselection_full_objects_mergedata_blind_batch_prime_over_5_6.RData")

# ==============================================================================
# 4. EVALUATION AND SUMMARY STATISTICS
# ==============================================================================
load("C:/Users/ngoune/Documents/Projet I/Protein_Modeling_share/Cross_Data_Analysis/Funktionen_Merged_Data/BATCH_PRIME_OVERLAP/Models_rf_preselection_full_objects_mergedata_blind_batch_prime_over_5_6.RData")

res.rna <- gof.all.complete(model = lasso.rf.pre.full.mergedata_blind_rna_batch_prime_over_5_6, prediction.method = "lasso")
res.prot <- gof.all.complete(model = lasso.rf.pre.full.mergedata_blind_protein_batch_prime_over_5_6, prediction.method = "lasso")
res.comb <- gof.all.complete(model = lasso.rf.pre.full.mergedata_blind_combined_batch_prime_over_5_6, prediction.method = "lasso")

cat("\n=== RNA CORRELATIONS ===\n")
cor_rna <- sapply(lasso.rf.pre.full.mergedata_blind_rna_batch_prime_over_5_6, function(x) as.numeric(x$prediction.obj$model$correlation.pearson))
...
cor_prot <- sapply(lasso.rf.pre.full.mergedata_blind_protein_batch_prime_over_5_6, function(x) as.numeric(x$prediction.obj$model$correlation.pearson))
...
cor_comb <- sapply(lasso.rf.pre.full.mergedata_blind_combined_batch_prime_over_5_6, function(x) as.numeric(x$prediction.obj$model$correlation.pearson))
