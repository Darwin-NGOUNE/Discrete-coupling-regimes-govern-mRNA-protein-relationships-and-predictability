...
# DiPa Cluster 1_2
# This script runs the Mastery 10 modeling (predefined top 10 Mastery Hubs) for DiPa Cluster 1_2
...
lasso.rf.pre.full.mergedata_blind_mastery50_protein_batch_over_1_2_24 <- pblapply(FUN = protein.regression.complete,
                                                           pairs.list.final,
                                                           dataset = Full_DT,
                                                           weighted = FALSE,
...
lasso.rf.pre.full.mergedata_blind_mastery50_plus_rna_batch_over_1_2_24 <- pblapply(FUN = protein.regression.complete,
                                                           pairs.list.final,
                                                           dataset = Full_DT,
                                                           weighted = FALSE,
                                                           grouping = "all",          # <-- grouping all to build full design matrix
...
# SAVE RESULTS
save(lasso.rf.pre.full.mergedata_blind_mastery50_protein_batch_over_1_2_24,
     lasso.rf.pre.full.mergedata_blind_mastery50_plus_rna_batch_over_1_2_24,
     file = "Models_mastery50_mergedata_blind_batch_over_1_2_24.RData")

# ==============================================================================
# 4. EVALUATION AND SUMMARY STATISTICS
# ==============================================================================
# # load("C:/Users/ngoune/Documents/Projet I/Protein_Modeling_share/Cross_Data_Analysis/Funktionen_Merged_Data/BATCH_PRIME_OVERLAP/Mastery50/Models_mastery50_mergedata_blind_batch_over_1_2_24.RData")
# 
# res.m10 <- gof.all.complete(model = lasso.rf.pre.full.mergedata_blind_mastery50_protein_batch_over_1_2_24, prediction.method = "lasso")
# 
# cat("\n=== MASTERY 10 PROTEIN CORRELATIONS ===\n")
# cor_m10 <- sapply(lasso.rf.pre.full.mergedata_blind_mastery50_protein_batch_over_1_2_24, function(x) as.numeric(x$prediction.obj$model$correlation.pearson))
