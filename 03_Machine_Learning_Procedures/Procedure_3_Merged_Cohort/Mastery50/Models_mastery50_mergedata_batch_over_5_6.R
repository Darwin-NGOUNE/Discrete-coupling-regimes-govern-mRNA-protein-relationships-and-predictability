...
lasso.rf.pre.full.mergedata_blind_mastery50_protein_batch_over_5_6 <- pblapply(FUN = protein.regression.complete,
                                                           pairs.list.final,
                                                           dataset = Full_DT,
                                                           weighted = FALSE,
...
lasso.rf.pre.full.mergedata_blind_mastery50_plus_rna_batch_over_5_6 <- pblapply(FUN = protein.regression.complete,
                                                           pairs.list.final,
                                                           dataset = Full_DT,
                                                           weighted = FALSE,
                                                           grouping = "all",          # <-- grouping all to build full design matrix
...
# SAVE RESULTS
save(lasso.rf.pre.full.mergedata_blind_mastery50_protein_batch_over_5_6,
     lasso.rf.pre.full.mergedata_blind_mastery50_plus_rna_batch_over_5_6,
     file = "Models_mastery50_mergedata_blind_batch_over_5_6.RData")

# ==============================================================================
# 4. EVALUATION AND SUMMARY STATISTICS
# ==============================================================================
# # load("C:/Users/ngoune/Documents/Projet I/Protein_Modeling_share/Cross_Data_Analysis/Funktionen_Merged_Data/BATCH_PRIME_OVERLAP/Mastery50/Models_mastery50_mergedata_blind_batch_over_5_6.RData")
# 
# res.m10 <- gof.all.complete(model = lasso.rf.pre.full.mergedata_blind_mastery50_protein_batch_over_5_6, prediction.method = "lasso")
# 
# cat("\n=== MASTERY 10 PROTEIN CORRELATIONS ===\n")
# cor_m10 <- sapply(lasso.rf.pre.full.mergedata_blind_mastery50_protein_batch_over_5_6, function(x) as.numeric(x$prediction.obj$model$correlation.pearson))
