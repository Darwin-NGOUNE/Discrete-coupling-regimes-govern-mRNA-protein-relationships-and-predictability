...
rf.rf.pre.full.CD.new_protein_DTccl4_prime_cluster_0_sub <- pblapply(FUN = protein.regression.complete,
                                                                        pairs.list.0.sub,
                                                                        dataset = CCL4_Full,
                                                                        weighted = FALSE,
                                                                        grouping = "all",
...
# 3. SAVE RESULTS
save(rf.rf.pre.full.CD.new_protein_DTccl4_prime_cluster_0_sub,
     file = "C:/Users/ngoune/Documents/Projet I/Protein_Modeling_share/New_Data/Cluster_Modelierung/Intra_RF_RF/Models_rf_rf_preselection_full_objects_CD_new_DTccl4_prime_cluster_0_sub.RData")
