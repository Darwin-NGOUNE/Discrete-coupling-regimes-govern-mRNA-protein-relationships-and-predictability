...
# A. RNA-only model
lasso.rf.pre.full.CD.new_rna_LCPM_prime_cluster_1_2_sub <- pblapply(FUN = protein.regression.complete,
                                                          pairs.list.1.2.sub,
...
lasso.rf.pre.full.CD.new_protein_LCPM_prime_cluster_1_2_sub <- pblapply(FUN = protein.regression.complete,
                                                              pairs.list.1.2.sub,
                                                              dataset = BDL_Full,
                                                              weighted = FALSE,
                                                              grouping = "all",
...
# C. Combined model
lasso.rf.pre.full.CD.new_combined_LCPM_prime_cluster_1_2_sub <- pblapply(FUN = protein.regression.complete,
                                                               pairs.list.1.2.sub,
                                                               dataset = BDL_Full,
                                                               weighted = FALSE,
                                                               grouping = "all",
...
# 3. SAVE RESULTS
save(lasso.rf.pre.full.CD.new_rna_LCPM_prime_cluster_1_2_sub,
     lasso.rf.pre.full.CD.new_protein_LCPM_prime_cluster_1_2_sub,
     lasso.rf.pre.full.CD.new_combined_LCPM_prime_cluster_1_2_sub,
     file = "Models_rf_preselection_full_objects_CD_new_LCPM_prime_cluster_1_2_sub.RData")
