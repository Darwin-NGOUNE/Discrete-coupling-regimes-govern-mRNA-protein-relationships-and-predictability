...
# A. RNA-only model
lasso.rf.pre.full.CD.new_rna_DTccl4_prime_cluster_3_4 <- pblapply(FUN = protein.regression.complete,
                                                          pairs.list.3.4,
...
lasso.rf.pre.full.CD.new_protein_DTccl4_prime_cluster_3_4 <- pblapply(FUN = protein.regression.complete,
                                                              pairs.list.3.4,
                                                              dataset = CCL4_Full,
                                                              weighted = FALSE,
                                                              grouping = "all",
...
# C. Combined model
lasso.rf.pre.full.CD.new_combined_DTccl4_prime_cluster_3_4 <- pblapply(FUN = protein.regression.complete,
                                                               pairs.list.3.4,
                                                               dataset = CCL4_Full,
                                                               weighted = FALSE,
                                                               grouping = "all",
...
# 3. SAVE RESULTS
save(lasso.rf.pre.full.CD.new_rna_DTccl4_prime_cluster_3_4,
     lasso.rf.pre.full.CD.new_protein_DTccl4_prime_cluster_3_4,
     lasso.rf.pre.full.CD.new_combined_DTccl4_prime_cluster_3_4,
     file = "Models_rf_preselection_full_objects_CD_new_DTccl4_prime_cluster_3_4.RData")
