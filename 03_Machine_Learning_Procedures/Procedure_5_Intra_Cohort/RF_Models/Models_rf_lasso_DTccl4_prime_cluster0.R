...
# A. RNA-only model
lasso.rf.pre.full.CD.new_rna_DTccl4_prime_cluster_0 <- pblapply(FUN = protein.regression.complete,
                                                          pairs.list.0,
...
lasso.rf.pre.full.CD.new_protein_DTccl4_prime_cluster_0 <- pblapply(FUN = protein.regression.complete,
                                                              pairs.list.0,
                                                              dataset = CCL4_Full,
                                                              weighted = FALSE,
                                                              grouping = "all",
...
# C. Combined model
lasso.rf.pre.full.CD.new_combined_DTccl4_prime_cluster_0 <- pblapply(FUN = protein.regression.complete,
                                                               pairs.list.0,
                                                               dataset = CCL4_Full,
                                                               weighted = FALSE,
                                                               grouping = "all",
...
# 3. SAVE RESULTS
save(lasso.rf.pre.full.CD.new_rna_DTccl4_prime_cluster_0,
     lasso.rf.pre.full.CD.new_protein_DTccl4_prime_cluster_0,
     lasso.rf.pre.full.CD.new_combined_DTccl4_prime_cluster_0,
     file = "Models_rf_preselection_full_objects_CD_new_DTccl4_prime_cluster_0.RData")
