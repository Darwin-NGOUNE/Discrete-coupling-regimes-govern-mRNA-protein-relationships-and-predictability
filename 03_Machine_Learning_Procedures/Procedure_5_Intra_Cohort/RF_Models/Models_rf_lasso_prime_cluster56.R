...
# A. RNA-only model
lasso.rf.pre.full.CD.new_rna_LCPM_prime_cluster_5_6 <- pblapply(FUN = protein.regression.complete,
                                                          pairs.list.5.6,
...
lasso.rf.pre.full.CD.new_protein_LCPM_prime_cluster_5_6 <- pblapply(FUN = protein.regression.complete,
                                                              pairs.list.5.6,
                                                              dataset = BDL_Full,
                                                              weighted = FALSE,
                                                              grouping = "all",
...
# C. Combined model
lasso.rf.pre.full.CD.new_combined_LCPM_prime_cluster_5_6 <- pblapply(FUN = protein.regression.complete,
                                                               pairs.list.5.6,
                                                               dataset = BDL_Full,
                                                               weighted = FALSE,
                                                               grouping = "all",
...
# 3. SAVE RESULTS
save(lasso.rf.pre.full.CD.new_rna_LCPM_prime_cluster_5_6,
     lasso.rf.pre.full.CD.new_protein_LCPM_prime_cluster_5_6,
     lasso.rf.pre.full.CD.new_combined_LCPM_prime_cluster_5_6,
     file = "Models_rf_preselection_full_objects_CD_new_LCPM_prime_cluster_5_6.RData")
