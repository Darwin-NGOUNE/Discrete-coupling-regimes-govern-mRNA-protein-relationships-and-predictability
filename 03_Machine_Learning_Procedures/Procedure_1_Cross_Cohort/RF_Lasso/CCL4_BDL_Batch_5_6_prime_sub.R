...
rf_lasso_full_rna_testing_Batch_prime_5_6_sub <- pblapply(FUN = protein.regression.function,
                                                          pairs.list,
                                                          dataset   = CCL4_Full,
                                                          newdata   = BDL_Full,
                                                          weighted = FALSE,
...
rf_lasso_full_proteins_testing_Batch_prime_5_6_sub  <- pblapply(FUN = protein.regression.function,
                                                                pairs.list,
                                                                dataset   = CCL4_Full,
                                                                newdata   = BDL_Full,
                                                                weighted = FALSE,
...
rf_lasso_full_combined_testing_Batch_prime_5_6_sub  <- pblapply(FUN = protein.regression.function,
                                                                pairs.list,
                                                                dataset   = CCL4_Full,
                                                                newdata   = BDL_Full,
                                                                weighted = FALSE,
...
# Save the models
output_file <- "C:/Users/ngoune/Documents/Projet I/Protein_Modeling_share/Cross_Data_Analysis/Funktionen_CD_Testing/Batch_corrected_prime_analysis/Models_rf_lasso_full_testing_Batch_prime_5_6_sub.RData"
save(rf_lasso_full_rna_testing_Batch_prime_5_6_sub ,
     rf_lasso_full_proteins_testing_Batch_prime_5_6_sub ,
     rf_lasso_full_combined_testing_Batch_prime_5_6_sub ,
     file = output_file)
