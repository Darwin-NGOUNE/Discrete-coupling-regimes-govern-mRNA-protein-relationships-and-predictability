...
# rf_rf_full_rna_testing_Batch_prime_5_6_sub <- pblapply(FUN = protein.regression.function,
#                                                           pairs.list,
#                                                           dataset   = CCL4_Full,
#                                                           newdata   = BDL_Full,
#                                                           weighted = FALSE,
...
rf_rf_full_proteins_testing_Batch_prime_5_6_sub  <- pblapply(FUN = protein.regression.function,
                                                                pairs.list,
                                                                dataset   = CCL4_Full,
                                                                newdata   = BDL_Full,
                                                                weighted = FALSE,
...
# rf_rf_full_combined_testing_Batch_prime_5_6_sub  <- pblapply(FUN = protein.regression.function,
#                                                                 pairs.list,
#                                                                 dataset   = CCL4_Full,
#                                                                 newdata   = BDL_Full,
#                                                                 weighted = FALSE,
...
# 
# # Save the models
# output_file <- "C:/Users/ngoune/Documents/Projet I/Protein_Modeling_share/Cross_Data_Analysis/Funktionen_CD_Testing/Batch_corrected_prime_analysis/RF_RF/Models_rf_rf_full_testing_Batch_prime_5_6_sub.RData"
# # save(rf_rf_full_rna_testing_Batch_prime_5_6_sub ,
# #      rf_rf_full_proteins_testing_Batch_prime_5_6_sub ,
# #      rf_rf_full_combined_testing_Batch_prime_5_6_sub ,
# #      file = output_file)
# # cat("\nModels saved successfully to:", output_file, "\n")
# save(rf_rf_full_proteins_testing_Batch_prime_5_6_sub ,
#      file = output_file)
# cat("\nModels saved successfully to:", output_file, "\n")


save(rf_rf_full_proteins_testing_Batch_prime_5_6_sub,
     file = "Models_rf_rf_rf_full_testing_Batch_prime_5_6_sub.RData"
)
...
# load("C:/Users/ngoune/Documents/Projet I/Protein_Modeling_share/Cross_Data_Analysis/Funktionen_CD_Testing/Batch_corrected_prime_analysis/Models_rf_lasso_full_testing_Batch_prime_5_6_sub.RData")
# 
# 
# ######################rna#######################################################
# 
# cor_vals <- sapply(rf_lasso_full_rna_testing_Batch_prime_5_6_sub, function(x) {
...
# 
# 
# cor_vals1 <- sapply(rf_lasso_full_rna_testing_Batch_prime_5_6_sub, function(x) {
#   as.numeric(x$baseline.model$Pearson)
# })
# 
# sum(cor_vals1 < 0.5) #22
# sum(cor_vals1 >= 0.5) #1
# sum(cor_vals1 >= 0.8) #0
# 
# ################proteins########################################################
# 
# cor_vals <- sapply(rf_lasso_full_proteins_testing_Batch_prime_5_6_sub, function(x) {
#   as.numeric(x$model$correlation.pearson)
# })
# 
# sum(cor_vals < 0.5) #17
...
# ##################combined######################################################
# 
# cor_vals <- sapply(rf_lasso_full_combined_testing_Batch_prime_5_6_sub, function(x) {
#   as.numeric(x$model$correlation.pearson)
# })
# 
# sum(cor_vals < 0.5) #17
...
# rmse_bas <- sapply(rf_lasso_full_rna_testing_Batch_prime_5_6_sub , function(x) x$baseline.model$RMSE)
# mae_bas <- sapply(rf_lasso_full_rna_testing_Batch_prime_5_6_sub , function(x) x$baseline.model$MAE)
# cor_bas  <- sapply(rf_lasso_full_rna_testing_Batch_prime_5_6_sub , function(x) x$baseline.model$Pearson)
# 
# rmse_rna <- sapply(rf_lasso_full_rna_testing_Batch_prime_5_6_sub , function(x) x$model$rmse)
# mae_rna <- sapply(rf_lasso_full_rna_testing_Batch_prime_5_6_sub , function(x) x$model$mae)
# cor_rna  <- sapply(rf_lasso_full_rna_testing_Batch_prime_5_6_sub , function(x) x$model$correlation.pearson)
# 
# rmse_prot <- sapply(rf_lasso_full_proteins_testing_Batch_prime_5_6_sub , function(x) x$model$rmse)
# mae_prot <- sapply(rf_lasso_full_proteins_testing_Batch_prime_5_6_sub , function(x) x$model$mae)
# cor_prot  <- sapply(rf_lasso_full_proteins_testing_Batch_prime_5_6_sub , function(x) x$model$correlation.pearson)
# 
# rmse_comb <- sapply(rf_lasso_full_combined_testing_Batch_prime_5_6_sub , function(x) x$model$rmse)
# mae_comb <- sapply(rf_lasso_full_combined_testing_Batch_prime_5_6_sub , function(x) x$model$mae)
# cor_comb  <- sapply(rf_lasso_full_combined_testing_Batch_prime_5_6_sub , function(x) x$model$correlation.pearson)
# 
...
# 1 Baseline 0.5837503 0.4464951  -0.05006306
# 2      RNA 0.7571207 0.6055466  -0.02388255
# 3  Protein 0.6144265 0.4752512   0.10218858
# 4 Combined 0.6411126 0.5036535   0.07869930
