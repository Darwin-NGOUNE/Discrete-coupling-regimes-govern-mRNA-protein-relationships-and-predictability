...
# rf_rf_full_rna_testing_Batch_prime_3_4_sub <- pblapply(FUN = protein.regression.function,
#                                                           pairs.list,
#                                                           dataset   = CCL4_Full,
#                                                           newdata   = BDL_Full,
#                                                           weighted = FALSE,
...
rf_rf_full_proteins_testing_Batch_prime_3_4_sub  <- pblapply(FUN = protein.regression.function,
                                                                pairs.list,
                                                                dataset   = CCL4_Full,
                                                                newdata   = BDL_Full,
                                                                weighted = FALSE,
...
# rf_rf_full_combined_testing_Batch_prime_3_4_sub  <- pblapply(FUN = protein.regression.function,
#                                                                 pairs.list,
#                                                                 dataset   = CCL4_Full,
#                                                                 newdata   = BDL_Full,
#                                                                 weighted = FALSE,
...
# 
# # Save the models
# output_file <- "C:/Users/ngoune/Documents/Projet I/Protein_Modeling_share/Cross_Data_Analysis/Funktionen_CD_Testing/Batch_corrected_prime_analysis/RF_RF/Models_rf_rf_full_testing_Batch_prime_3_4_sub.RData"
# # save(rf_rf_full_rna_testing_Batch_prime_3_4_sub ,
# #      rf_rf_full_proteins_testing_Batch_prime_3_4_sub ,
# #      rf_rf_full_combined_testing_Batch_prime_3_4_sub ,
# #      file = output_file)
# # cat("\nModels saved successfully to:", output_file, "\n")
# save(rf_rf_full_proteins_testing_Batch_prime_3_4_sub ,
#      file = output_file)
# cat("\nModels saved successfully to:", output_file, "\n")


save(rf_rf_full_proteins_testing_Batch_prime_3_4_sub,
     file = "Models_rf_rf_rf_full_testing_Batch_prime_3_4_sub.RData"
)
